...
<header class="header-section">
                ...
                <nav class="main-menu mobile-menu">
                    <ul>
                       ...
                       <li><a href="item_sd.php">Items</a></li>
                        <li><a href="users_sd.php" class="active">Users</a></li>
    ...
    <div class="col-lg-12 jumbotron">
     <div class="cart-table">
            <form class="form-horizontal" method="post" action="users_sd.php">
            ...
            <tr>
                ...
                <td><?php echo $row['u_type'] ?></td>
                   <td>
                    ...
                    <a class="btn btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="users_sd.php?del=<?php echo $row['u_id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
