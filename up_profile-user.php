...
<div class="container jumbotron">
    <div class="row">
        ...
        <div class="col-sm-8">
           <form method="post" action="profile-user.php">
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="username"  class="form-control" value="<?php echo $_SESSION['firstname'] ?>">
                </div>
                <div class="form-group">
                    <label><b>Last Name</b></label>
                    <input type="text" name="password"  class="form-control" value="<?php echo $_SESSION['lastname'] ?>">
                </div>
                <div class="form-group">
                    <label><b>Position</b></label>
                    <input type="text" name="firstname"  class="form-control" value="<?php echo $_SESSION['position'] ?>">
                </div>
                <div class="form-group">
                    <label><b>Login Type</b></label>
                    <input type="text" name="lastname"  class="form-control" value="<?php echo $_SESSION['u_type'] ?>">
                </div>
                <div class="form-group" >
