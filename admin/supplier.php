...
<header class="header-section">
            ...
            <div class="inner-header">
                ...
                <nav class="main-menu mobile-menu">
                    <ul>
                        ...
                        <li><a href="supplier.php" class="active">Suppliers</a>
    ...
    <div class="container border-top-generic">
        <a href="#" class="genric-btn success" name="combtn" style="margin-left: 20%;">SAVE</a>
                    ...
                    <thead>
                        ...
                        <tr>
                            <td>
                             ...
                             <td>
                                <div>
                                    <input type="text" value="San Carlos, Pangasinan" class="productname">
                                </div>
                            </td>
                             <td>
                                <div>
                            ...
                            <td>
                             ...
                             <td>
                                <div>
                                    <input type="text" value="Lingayen, Pangasinan" class="productname">
                                </div>
                            </td>
                            <td>
                                <div>
                            ...
                            <td>
                             ...
                             <td>
                                <div>
                                    <input type="text" value="Dagupan City" class="productname">
                                </div>
                            </td>
                            <td>
                                <div>
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Supplier Code</label>
