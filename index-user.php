...
<header class="header-section">
        <div class="container-fluid">
            <div class="inner-header">
                <div class="logo">
                    <a href="./index.html"><img src="img/logo102.jpg" alt=""></a>
                </div>
            
                  <nav class="main-menu mobile-menu">
                    <ul>
                        <li><a href="index-user.php" class="active">Home</a></li>
     ...
     <div class="container-fluid jumbotron">
        <section class="row " id="dash">
            ...
            <div class="col-sm-3" id="border">
                ...
                <a href="item-user.php"><h2>ITEMS</h2> </a> 
                <br>
                 <?php
                    $con=mysqli_connect('localhost','root','','inventory');
                ...
                <img src="img/users.png" id="users">
                 <a href="supplier-user.php"><h2 id="ich2">SUPPLIERS</h2></a> 
                <br>
                <?php
                    $con=mysqli_connect('localhost','root','','inventory');
